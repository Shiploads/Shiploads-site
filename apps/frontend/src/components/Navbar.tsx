...
export default function Navbar() {
  return (
    <nav className="bg-brand-green py-3 px-6 flex items-center justify-between sticky top-0 z-50 shadow-lg ">
      {/* Left: Logo and Home */}
      ...
      <div className="flex items-center gap-4">
        ...
        />
        <Link href="/login" className="bg-brand-orange hover:bg-brand-red text-white px-4 py-1 rounded-full transition font-semibold">
          Login
        </Link>
